...
Shares Button's motion treatment exactly: hover/pressed/focus color transitions use `fade-quick`. No pressed-state scale or other transform-based motion - pressed feedback is color-only.
