...
export const LifeInsurancePolicyIcon = React.memo(function LifeInsurancePolicyIcon(props: IconProps) {
  return (
...
LifeInsurancePolicyIcon.displayName = 'LifeInsurancePolicyIcon';
